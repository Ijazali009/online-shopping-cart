                      ...
                      <div class="contact-info-wrapper py-4 py-xl-5">
                        ...
                        <div class="d-flex mb-4 mb-xxl-5">
                          ...
                          <div>
                            ...
                            <address class="mb-0 text-light opacity-75">karachi, pakistan</address>
                          </div>
                        </div>
                          ...
                          <div class="col-12 col-xxl-6">
                            <div class="d-flex mb-4 mb-xxl-0">
                              ...
                              <div>
                                ...
                                <p class="mb-0">
                                  <a class="link-light link-opacity-75 link-opacity-100-hover text-decoration-none" href="tel:03184834180">03184834180</a>
                                </p>
                              </div>
                            </div>
                          </div>
                          <div class="col-12 col-xxl-6">
                            <div class="d-flex mb-0">
                              ...
                              <div>
                                ...
                                <p class="mb-0">
                                  <a class="link-light link-opacity-75 link-opacity-100-hover text-decoration-none" href="mailto:ijaz1233467@gmail.com">ijazali@gmail.com</a>
                                </p>
                              </div>
                            </div>
                          </div>
                        ...
                        <div class="d-flex">
                          ...
                          <div>
                            ...
                            <div class="d-flex mb-1">
                              ...
                              <p class="text-light opacity-75 mb-0">08.00 To 18.00</p>
                            </div>
                            <div class="d-flex">
                              <p class="text-light fw-bold mb-0 me-5">Sat - Sun</p>
                              <p class="text-light opacity-75 mb-0">09.00 To 20.00</p>
                            </div>
                          </div>
                        </div>
                      </div>
